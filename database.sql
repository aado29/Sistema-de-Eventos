...
INSERT INTO `volunteers` (`id`, `ci`, `firstName`, `lastName`, `address`, `phone`, `email`, `sizeShirt`, `sizePants`, `sizeShoes`, `position`, `profession`, `speciality`, `employment`, `id_team`, `id_vehicle`, `type`, `state`) VALUES
